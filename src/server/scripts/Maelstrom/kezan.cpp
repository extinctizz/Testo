...
#define SAY_WORK_1 "Desole, mec. Ca se r'produira plus."
#define SAY_WORK_2 "J'y vais, j'y vais !"
#define SAY_WORK_3 "La DRH, elle va entendre parler d'vous !"
#define SAY_WORK_4 "Le travail c'etait mieux a Terremine !"
#define SAY_WORK_5 "Ouille ! ca fait mal !"
#define SAY_WORK_6 "Oups, fin de la pause."
#define SAY_WORK_7 "Pas le taser, mec !"
#define SAY_WORK_8 "Qu'est-c'qui va pas ? Pourquoi ma pause dejeuner et mes deux pauses gouter par jour, j'y ai pas droit, mec ?"
...
#define SAY_D_A "Ce vin blanc petillant est delicieux. Ou l.avez-vous trouve ?"
#define SAY_D_B "Je me sens beaucoup mieux maintenant. hic !"
#define SAY_D_C "Merchi !"
#define SAY_D_D "Beuh. j'ai besoin d'un seau !"
#define SAY_D_E "Je me sens beaucoup mieux maintenant. hic !"
#define SAY_D_F "C'est super-bon , merci!"
#define SAY_D_G "J'ai faim ! Mais ou est la bouffe bon sang ?"
#define SAY_D_H "Merci. J'etais bientot a cours. Miam Miam !"
#define SAY_D_I "Delicieux ! Et ce ne sont que les hors-d'.uvre ?"
#define SAY_D_J "Si seulement j'avais quelqu'un avec qui danser."
#define SAY_D_K "Cette fete manque un peu de brillant :( ."
#define SAY_D_L "Oh yeahhhh ! Nice une boule disco ! Let's go PARTY woohoo !"
#define SAY_D_M "Ah la j'adore ! Aller faite bouger vos fesse Wouhou!"
#define SAY_D_N "J'aime les feux d'artifice ! Il faut que sa pete dans les tympan et que cela nous eblouisse la vue."
#define SAY_D_O "Wouhou, des feux d'artifice ! Encore, encore !"
#define SAY_D_P "Woahhh ! J'ai jamais vu quelque chose d'aussi geniale . Encore !!! Encore !!!"
#define SAY_D_Q "Refaire le plein, sa serait pas inutile."
    ...
    struct npc_citoyen_gobAI : public ScriptedAI
    {
        ...
        void MoveInLineOfSight(Unit* who)
        {
            ...
            if (who->GetEntry() == 34840)
            {
                ...
                {
                case 0 :
                    me->MonsterYell("Apprends a conduire, espece de tare !", LANG_UNIVERSAL, 0);
                    break;
                case 1 :
                    me->MonsterYell("Le prince marchand va en entendre parler, je peux vous le dire !", LANG_UNIVERSAL, 0);
                    break;
                case 2 :
                    me->MonsterSay("Mais regardez ou vous allez !", LANG_UNIVERSAL, 0);
                    break;
                case 3 :
                    me->Kill(me);
                    return ;
                case 4 :
                    me->MonsterSay("Mon avocat ne va pas vous rater !", LANG_UNIVERSAL, 0);
                    break;
                case 5 :
                    me->MonsterSay("Mon cou ! Je vais vous coller un proces !", LANG_UNIVERSAL, 0);
                    break;
                case 6 :
                    me->MonsterSay("On se reverra au tribunal !", LANG_UNIVERSAL, 0);
                    break;
                case 7 :
                    me->MonsterSay("Ouille !", LANG_UNIVERSAL, 0);
                    break;
                case 8 :
                    me->MonsterSay("Vous etes un vrai danger public !", LANG_UNIVERSAL, 0);
                    break;
                case 9 :
                    me->MonsterYell("Docteur !", LANG_UNIVERSAL, 0);
                    break;
                default :
                    break;
                }
...
public:
        ...
        if (action == GOSSIP_ACTION_INFO_DEF + 1)
        {
                                                     ...
                                                     creature->GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 300*IN_MILLISECONDS))
            {
                if (Creature *c = player->SummonCreature(creature->GetEntry(), creature->GetPositionX(), creature->GetPositionY(),  creature->GetPositionZ(),
                                                         creature->GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 300*IN_MILLISECONDS))
                {
                    c->MonsterSay("Donnez moi les clefs patron, je conduit !", LANG_UNIVERSAL, 0);
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        if (player->GetQuestStatus(14126) != QUEST_STATUS_NONE)
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Oui , je veut y aller !", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
public:
    ...
    struct npc_hot_rodAI : public npc_escortAI
    {
        ...
        void WaypointReached(uint32 i)
        {
            ...
            {
            case 4:
                chipie->MonsterSay("Accrochez vous ! J'appui sur le champignon !", LANG_UNIVERSAL, 0);
                break;
            case 16:
                chipie->MonsterSay("Nous devons faire le tour !", LANG_UNIVERSAL, 0);
                chipie->MonsterSay("Accrochez vous ! J'appui sur le champignon !", LANG_UNIVERSAL, 0);
                break;
            case 17:
                chipie->MonsterYell("Degagez le passage !", LANG_UNIVERSAL, 0);
                break;
            case 26:
                me->SetCanFly(true);
