...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        bool NeedSynchronisation() { return needSynchronisation; }
        uint32 GetWotlkGUID() { return wotlkGUID; }
        ...
        bool HasMigration() { return m_ExtraFlags & PLAYER_EXTRA_RECUP; }
