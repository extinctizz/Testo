    ...
    for (uint32 i = 0; i < mSpellInfoMap.size(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            case 100951:
                ...
                spellInfo->Effects[EFFECT_1].BasePoints = 200;
           ...
           case 98619:
               ...
               break;
                // custom mounts
            case 89520: // goblin car
                spellInfo->Effects[EFFECT_0].MiscValue = 2000001;
                break;
            case 61983: // hunt exotic panthere
                spellInfo->Effects[EFFECT_0].MiscValue = 2000000;
                break;
            case 46980: // hunt exotic panthere
                spellInfo->Effects[EFFECT_0].MiscValue = 2000002;
                break;
                // end custom mounts
            case 68827:
