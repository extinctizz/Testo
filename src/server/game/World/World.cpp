...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_ARENA_SOLO_QUEUE_ENABLED]                  = sConfigMgr->GetBoolDefault("Arena.Soloqueue.Enable", true);
...
void World::Update(uint32 diff)
{
    ...
    sObjectMgr->_migration->Update(diff);

    // update arena log system
    //    sObjectMgr->_arenaLogs->Update(diff);
